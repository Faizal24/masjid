                ...
                <div class="container clearfix">
                    ...
                    <nav id="primary-menu" class="dark">
                        ...
                        <ul>
                            ...
                            <li class="current"><a href="hubungikami"><div>Hubungi Kami</div></a></li>
                        </ul>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col-md-7 bottommargin">
						...
						<section id="map" class="gmap" style="height: 240px;"></section>
					...
					<div class="col-md-5">
						...
						<!-- Modal Contact Form
						============================================= -->
						<a href="#" data-toggle="modal" data-target="#contactFormModal" class="button button-3d nomargin btn-block button-xlarge hidden-xs center">Kirimkan Email Kepada Kami</a>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="contactFormModalLabel">Kirimkan Email Kepada Kami</h4>
									</div>
					...
					<div class="row clear-bottommargin">
						...
						<div class="col-md-3 col-sm-6 bottommargin clearfix">
							<div class="feature-box fbox-center fbox-bg fbox-plain">
								...
								<h3>Alamat Kami<span class="subtitle">Kg Kuala Pangsun, Hulu Langat, Selangor</span></h3>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6 bottommargin clearfix">
							<div class="feature-box fbox-center fbox-bg fbox-plain">
								...
								<h3>Hubungi Kami<span class="subtitle">+6019-2338393</span></h3><br>
							</div>
						</div>

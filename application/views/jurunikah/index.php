						...
						<div class="col-md-8 col-md-offset-2 bottommargin">
							...
							<div class="team team-list clearfix">
								<div class="team-image">
									<img src="images/masjid/organisasi/tiada.png" alt="John Doe">
								</div>
								<br><br><br><br>
								<div class="team-desc">
									<div class="team-title"><h4>AF Ustaz Khairizal Hj Abu Bakar<br><p>(Al Azhar, Mesir)</p></h4><span>Penolong Pendaftar Jurunikah Masjid Pangsun</span></div>
									<div class="team-content">
										<p>No Telephone : 017-602 9345.</p>
									</div>
								</div>
							</div>

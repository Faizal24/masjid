                ...
                <div class="container clearfix">
                    ...
                    <div class="postcontent nobottommargin clearfix" style="width: 100%">
                        ...
                        <div class="heading-block fancy-title nobottomborder">
                            <center><h3 class="nobottommargin"><span><b>Jadual Kuliah Harian</b></span></h3></center>
                        </div>
                        <br>
                        ...
                        <div class="tabs tabs-responsive clearfix">
                            ...
                            <ul class="tab-nav clearfix">
                                <li><a href="#tab-responsive-1">Isnin</a></li>
                                <li><a href="#tab-responsive-2">Selasa</a></li>
                                <li><a href="#tab-responsive-3">Rabu</a></li>
                                <li><a href="#tab-responsive-4">Khamis</a></li>
                                <li><a href="#tab-responsive-5">Jumaat</a></li>
                                <li><a href="#tab-responsive-6">Sabtu</a></li>
                                <li><a href="#tab-responsive-7">Ahad</a></li>
                            </ul>
                            ...
                            <div class="tab-container">
                                ...
                                <div class="tab-content clearfix" id="tab-responsive-1">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="heading-block fancy-title nobottomborder title-bottom-border">
                                                <center><h4>Kuliah <span>Subuh</span></h4></center>
                                            </div>
                                            <div>
                                                <center><img src="images/masjid/ustaz.jpg"></center><br>
                                                <center><h4>Tarikh : <span>13 March 2017</span><br>Penceramah : <span>Ustaz Syafiq</span><br>Tajuk : <span>Berpuasa di bulan Ramadhan</span></h4></center>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="heading-block fancy-title nobottomborder title-bottom-border">
                                                <center><h4>Kuliah <span>Zohor</span></h4></center>
                                            </div>
                                            <div>
                                                <center><img src="images/masjid/ustaz.jpg"></center><br>
                                                <center><h4>Tarikh : <span>13 March 2017</span><br>Penceramah : <span>Ustaz Syafiq</span><br>Tajuk : <span>Berpuasa di bulan Ramadhan</span></h4></center>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="heading-block fancy-title nobottomborder title-bottom-border">
                                                <center><h4>Kuliah <span>Maghrib</span></h4></center>
                                            </div>
                                            <div>
                                                <center><img src="images/masjid/ustaz.jpg"></center><br>
                                                <center><h4>Tarikh : <span>13 March 2017</span><br>Penceramah : <span>Ustaz Syafiq</span><br>Tajuk : <span>Berpuasa di bulan Ramadhan</span></h4></center>
                                        ...
                                        <div class="col-md-6">
                                            <div class="heading-block fancy-title nobottomborder title-bottom-border">
                                                <center><h4>Kuliah <span>Isya</span></h4></center>
                                            </div>
                                            <div>
                                                <center><img src="images/masjid/ustaz.jpg"></center><br>
                                                <center><h4>Tarikh : <span>13 March 2017</span><br>Penceramah : <span>Ustaz Syafiq</span><br>Tajuk : <span>Berpuasa di bulan Ramadhan</span></h4></center>
                                ...
                                <div class="tab-content clearfix" id="tab-responsive-7">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="heading-block fancy-title nobottomborder title-bottom-border">
                                                <center><h4>Kuliah <span>Subuh</span></h4></center>
